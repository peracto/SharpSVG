...
namespace Peracto.Svg.Render.Dx.Render
{
    public class RendererDirect2D : IDisposable
    {
        ...
        private WIC.BitmapTransformOptions GetExifRotation(WIC.BitmapFrameDecode frame)
        {
            try
            {
                using (var mdr = frame.MetadataQueryReader)
                {
                    if (mdr == null || !mdr.TryGetMetadataByName("/app1/{ushort=0}/{ushort=274}", out var vv).Success)
                        return 0;
                    switch ((ushort) vv)
                    {
                        case 0: return WIC.BitmapTransformOptions.Rotate0;
                        case 1: return WIC.BitmapTransformOptions.Rotate0;
                        case 2: return WIC.BitmapTransformOptions.Rotate0 | WIC.BitmapTransformOptions.FlipHorizontal;
                        case 3: return WIC.BitmapTransformOptions.Rotate180;
                        case 4: return WIC.BitmapTransformOptions.Rotate180 | WIC.BitmapTransformOptions.FlipVertical;
                        case 5: return WIC.BitmapTransformOptions.Rotate270 | WIC.BitmapTransformOptions.FlipHorizontal;
                        case 6: return WIC.BitmapTransformOptions.Rotate90;
                        case 7: return WIC.BitmapTransformOptions.Rotate90 | WIC.BitmapTransformOptions.FlipHorizontal;
                        case 8: return WIC.BitmapTransformOptions.Rotate270;
                        default: return 0;
                    }
                }
            }
